...
class SkillPublishServiceTest {
    ...
    @Test
    void testPublishFromEntries_ShouldAutoPublishWhenReviewDisabled() throws Exception {
        ...
        SkillPublishService.PublishResult result = autoPublishService.publishFromEntries(
                namespaceSlug,
                entries,
                publisherId,
